...
plt.plot(ds_merge['height_m'])
plt.plot(ds_merge['depth_ft'])
plt.show()
ds_merge_sum = ds_merge.iloc[4000:6000]
plt.plot(ds_merge_sum['height_m'])
plt.plot(ds_merge_sum['depth_ft'])
plt.show()
...
plt.plot(us_merge['height_m'])
plt.plot(us_merge['depth_ft'])
plt.show()
us_merge_sum = us_merge.iloc[10000:12000]
plt.plot(us_merge_sum['height_m'])
plt.plot(us_merge_sum['depth_ft'])
plt.show()
